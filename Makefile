...
upload: Tonuino.ino.arduino.avr.nano.hex
	...
	arduino-cli ${ARDUINO_OPTIONS} upload -v -b arduino:avr:nano:cpu=atmega328old -p ${TTY}

Tonuino.ino.arduino.avr.nano.hex: Tonuino.ino
	arduino-cli ${ARDUINO_OPTIONS} compile -b arduino:avr:nano:cpu=atmega328old --warnings more
